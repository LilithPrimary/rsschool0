...
[+] 5. Очень высокое качество оформления приложения и/или дополнительный не предусмотренный в задании функционал, улучшающий качество приложения +10
    ...
    - дополнительным функционалом может быть, например, наличие на карточке фильма его описания и рейтинга на IMDb (это всё есть, ещё есть клёвый поиск, над которым я сидела сутки, и прыгающие логотипы и кнопка для большего количества фильмов =))`
